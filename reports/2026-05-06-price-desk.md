...
| 🟣 Dimension | 🟣 Message | 🟣 Evidence |
|---|---|---|
| 01_adversarial | unguarded sys.argv indexing (no len-check or argparse) | /Users/danny/Desktop/CLAUDE CODE/price-desk/scripts/desk_verify.py:195 |
| 01_adversarial | unguarded sys.argv indexing (no len-check or argparse) | /Users/danny/Desktop/CLAUDE CODE/price-desk/scripts/price.py:367 |
| 06_types | Type-hint coverage 31% (< 50% threshold) | /Users/danny/Desktop/CLAUDE CODE/price-desk/scripts/ — 5/16 functions annotated |
...
| 12_prompt_injection | prompt-injection probe skipped — running in mock mode (ANTHROPIC_API_KEY missing or AUTO_TEST_MOCK=1). Set ANTHROPIC_API_KEY to enable live probing. | /Users/danny/Desktop/CLAUDE CODE/price-desk |
